	...
	<table class="sales_table_100" id="register">
		<thead>
			<tr>
				...
				<th style="width: 10%;"><?php echo $this->lang->line('sales_item_size'); ?></th>
				<th style="width: 10%;"><?php echo $this->lang->line('sales_item_color'); ?></th>
			...
			?>
					<?php echo form_open($controller_name."/edit_item/$line", array('class'=>'form-horizontal', 'id'=>'cart_'.$line)); ?>
						<tr>
							...
							<td><?php echo form_input(array('name' =>'size','class'=>'form-control input-md', 'value'=>$item['custom1'])); ?></td>
							<td><?php echo form_input(array('name' =>'color','class'=>'form-control input-md', 'value'=>$item['custom2'])); ?></td>
							<?php
