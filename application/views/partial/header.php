...
<head>
	...
	<?php else : ?>
		...
		<script type="text/javascript" src="dist/opensourcepos.js?rel=7538b4ac08"></script>
		...
		<div class="navbar navbar-default" role="navigation">
			<div class="container">
				<div class="navbar-header">
					...
					<a class="navbar-brand hidden-sm" href="<?php echo site_url(); ?>"><img src="<?php echo base_url();?>/images/logo.png" style="width: 110px;"></a>
				</div>
