...
class Items extends Secure_Controller
{
	...
	public function index()
	{
		...
		$data['filters'] = array('empty_upc' => $this->lang->line('items_empty_upc_items'),
			...
			'custom1'		=> $this->lang->line('item_custom1'),
			'custom2'		=> $this->lang->line('item_custom2'));
	...
	*/
	...
	//created to display images for barcode
	public function barcode_pic_thumb($pic_filename)
	{
		$this->load->helper('file');
		$this->load->library('image_lib');
