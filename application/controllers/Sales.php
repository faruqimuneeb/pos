...
class Sales extends Secure_Controller
{
	...
	public function item_search()
	{
		...
		//$suggestions = array_merge($suggestions, $this->Item->get_search_suggestions($search, array('search_custom' => TRUE, 'is_deleted' => FALSE), TRUE));
	...
	public function edit_item($item_id)
	{
		...
		//$this->form_validation->set_rules('size','lang:sales_item_size','required|callback_numeric');
		//$this->form_validation->set_rules('color','lang:sales_item_color','required|callback_numeric');
		...
		if($this->form_validation->run() != FALSE)
		{
			$this->sale_lib->edit_item($item_id, $description, $serialnumber, $quantity, $discount, $price, $discounted_total);//,$size,$color);
		}
		else
		{
